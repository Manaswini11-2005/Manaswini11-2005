...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>◈ AI Smart Vehicle System</h3>
      <p>Real-time road damage, pothole, and lane detection system powered by computer vision for intelligent transportation infrastructure.</p>
      <p>
        <img src="https://img.shields.io/badge/YOLOv8-FF4500?style=flat-square"/>
    ...
    <td width="50%" valign="top">
      <h3>◈ Brain Tumor Detection — Deep Learning</h3>
      <p>CNN-based medical imaging model achieving <strong>94% validation accuracy</strong> with Grad-CAM explainability and Streamlit deployment.</p>
      <p>
        <img src="https://img.shields.io/badge/CNN-FF6F00?style=flat-square"/>
        <img src="https://img.shields.io/badge/Grad--CAM-E34F26?style=flat-square"/>
  ...
  <tr>
    <td width="50%" valign="top">
      <h3>◈ Fake News Detection — NLP</h3>
      <p>NLP pipeline using TF-IDF vectorization and Logistic Regression, achieving <strong>96% classification accuracy</strong> on news credibility assessment.</p>
      <p>
        <img src="https://img.shields.io/badge/NLP-00D9FF?style=flat-square"/>
        <img src="https://img.shields.io/badge/TF--IDF-150458?style=flat-square"/>
        <img src="https://img.shields.io/badge/Scikit--learn-F7931E?style=flat-square"/>
        <img src="https://img.shields.io/badge/Python-3776AB?style=flat-square"/>
      </p>
    </td>
    <td width="50%" valign="top">
      <h3>◈ Sentiment-Driven Bitcoin Trading Analysis</h3>
      <p>Exploratory data analysis of Bitcoin trading behavior with sentiment correlation, statistical analysis, and interactive trend dashboards.</p>
      <p>
        <img src="https://img.shields.io/badge/Python-3776AB?style=flat-square"/>
        <img src="https://img.shields.io/badge/EDA-F2C811?style=flat-square"/>
        <img src="https://img.shields.io/badge/Statistical%20Analysis-336791?style=flat-square"/>
      </p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <h3>◈ Global Superstores Executive Dashboard</h3>
      <p>End-to-end Tableau dashboard delivering executive-level KPI analysis and actionable business insights across global retail operations.</p>
      <p>
        <img src="https://img.shields.io/badge/Tableau-E97627?style=flat-square"/>
        <img src="https://img.shields.io/badge/KPI%20Analysis-F7931E?style=flat-square"/>
        <img src="https://img.shields.io/badge/Business%20Intelligence-092E20?style=flat-square"/>
      </p>
    </td>
    <td width="50%" valign="top">
      <h3>◈ Global Sales Performance — Power BI</h3>
      <p>Interactive Power BI dashboard with DAX measures and Power Query transformations for multi-region sales performance tracking.</p>
      <p>
